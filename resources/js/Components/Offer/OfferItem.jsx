...
const OfferItem = ({className = 'bg-cyan-500', offer, ...props}) => {
  const classNames = `w-full h-96 flex items-center relative ${className}`
  const goToTheOffer = () => {
  ...
  return (
    <div className={classNames}>
      {
        offer.illustration && <img className='absolute h-full w-full object-cover object-top' src={`/storage/${offer.illustration}`} alt="illustration" />
      }
      <div className="mx-auto p-3 md:p-4  max-w-4xl w-full gap-y-3 lg:gap-y-4 flex flex-col z-20">
