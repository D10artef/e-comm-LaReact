...
const PageHeader = ({ title, createAction}) => {
  ...
  return (
    <>
      ...
      <div className="flex justify-end mb-3">
        {
          createAction && 
          <SimpleButton className='bg-accent self-start hover:bg-accent/80 rounded-sm shadow-sm text-white' onClick={createAction}>
              <span>Create</span>
